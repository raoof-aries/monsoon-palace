    ...
    <section id="contact" className="contactSection-wrapper">
      <div className="contactSection-container">
        ...
        <div className="contactSection-info">
          <span className="contactSection-badge">Get In Touch</span>
          ...
          <div className="contactSection-details">
            <div className="contactSection-detail">
          ...
          <div className="contactSection-social">
            <a href="#" className="contactSection-socialLink">
              <svg
                width="20"
                height="20"
                viewBox="0 0 24 24"
        ...
        <div className="contactSection-form">
          <form onSubmit={handleSubmit}>
            <div className="contactSection-formGrid">
              <div className="contactSection-inputGroup">
            ...
            <button type="submit" className="contactSection-submitBtn">
      ...
      <div className="contactSection-bgDecoration"></div>
    </section>
  );
};
