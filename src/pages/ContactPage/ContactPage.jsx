    ...
    >
      <motion.div className="contactPage-header" variants={staggerContainer}>
        ...
        <motion.h1 className="contactPage-title" variants={fadeInUp}>
          Plan Your Perfect <span className="contactPage-titleGradient">Escape</span>
        </motion.h1>
        ...
        <div className="contactPage-details">
          ...
          <div className="contactPage-detailRow">
            ...
            <div className="contactPage-text">
              <h4>Email</h4>
              <p>
                <a href="mailto:contact@keralamonsoonpalace.com">contact@keralamonsoonpalace.com</a><br />
                <a href="mailto:int.projects2020@gmail.com">int.projects2020@gmail.com</a>
              </p>
            </div>
          </div>
